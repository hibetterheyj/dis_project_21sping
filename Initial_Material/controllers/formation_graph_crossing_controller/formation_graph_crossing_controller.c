...
// graph-based control
#define FLOCK_SIZE	  10 // Size of formation (two 5-robot group)
int group_size = 5;
...
int main(){
	...
	while (true) {
		...
		// bugs
		//Error: wb_receiver_next_packet(): invalid device tag.
                                  //Error: wb_receiver_get_queue_length(): invalid device tag.
